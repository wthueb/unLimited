...
public:
	...
	virtual void                   DrawPrintText(const wchar_t* text, int textLen, FontDrawType drawType = FONT_DRAW_DEFAULT) = 0; // 28
	virtual void                   DrawUnicodeChar(wchar_t wch, FontDrawType drawType = FONT_DRAW_DEFAULT) = 0; // 29
