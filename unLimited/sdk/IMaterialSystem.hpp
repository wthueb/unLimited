...
public:
    ...
    virtual CreateInterfaceFn               Init(char const* pShaderAPIDLL, IMaterialProxyFactory *pMaterialProxyFactory, CreateInterfaceFn fileSystemFactory, CreateInterfaceFn cvarFactory = 0) = 0; // 9
    virtual void                            SetShaderAPI(char const *pShaderAPIDLL) = 0; // 10
    virtual void                            SetAdapter(int nAdapter, int nFlags) = 0;
    virtual void                            ModInit() = 0;
    virtual void                            ModShutdown() = 0;
    virtual void                            SetThreadMode(MaterialThreadMode_t mode, int nServiceThread = -1) = 0;
    virtual MaterialThreadMode_t            GetThreadMode() = 0; // 15
    ...
    virtual void                            unk() = 0;
    virtual MaterialHandle_t                FirstMaterial() const = 0; // 86
    virtual MaterialHandle_t                NextMaterial(MaterialHandle_t h) const = 0; // 87
    virtual MaterialHandle_t                InvalidMaterial() const = 0; // 88
    virtual IMaterial*                      GetMaterial(MaterialHandle_t h) const = 0; // 89
