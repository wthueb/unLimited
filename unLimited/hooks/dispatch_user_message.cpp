...
{
	static auto o_dispatch_user_message = client_hook->get_original<bool(__thiscall*)(void*, int, unsigned int, unsigned int, const void*)>(index::dispatch_user_message);
